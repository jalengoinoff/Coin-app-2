...
const News = () => {
  ...
  const handleSearch = (e) => {
    ...
    return (
      ...
      <h1 className="text-center mb-4" style={{ fontFamily: 'Abril Fatface' }}>
  News
</h1>
      <div className="mb-3 d-flex">
        ...
        />
        <button className={`${styles.searchButton} btn btn-primary mx-2`} onClick={handleSearch}>Search</button>
      </div>
      <div className="row">
        {news && news.length > 0 ? (
          news.map((item) => (
